...
def cria_copia_campo(m):
    ...
    copy = {}
    copy["col"], copy["lin"] = m["col"], m["lin"]
    copy["coords"] = {}

    for c in m["coords"].keys():
        copy["coords"][c] = cria_copia_parcela(m["coords"][c])
...
def coloca_minas(campo, coord, gerador, numero):
    ...
    while numero > i:
        ...
        if random == coord or coord in vizinhas or random in vizinhas \
                or (random_s in campo["coords"] and eh_parcela_minada(campo["coords"][random_s])) \
