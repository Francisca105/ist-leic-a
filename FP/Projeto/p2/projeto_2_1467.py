...
def gera_numero_aleatorio(g, n):
    """
    Esta função atualiza o estado do gerador e devolve um número aleatório
    no intervalo de [1,n] obtido a partir do novo estado da seed do gerador.
    --------------------------
    {"gerador" x int} -> {int}
    """
...
def gera_carater_aleatorio(g, c):
    """
    Esta função atualiza o estado do gerador e devolve um caracter aleatório da lista
    de letras de A até essa letra, obtido a partir do novo estado da seed do gerador.
    --------------------------
    {"gerador" x str} -> {str}
    """
...
def obtem_coordenadas_vizinhas(c):
    ...
    while n <= 8:
        ...
        # Visualmente, o que o loop vai verificando é: (c é a coordenada pretendida)
        # 1 2 3
        # 8 c 4
        # 7 6 5
